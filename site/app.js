...
const copy = {
  zh: {
    ...
    skeletonIntro: "骨架不是词表。每个节点都有类型、问题、前置、适用边界和学习优先级；当前先用四类模板域验证结构。",
  ...
  en: {
    ...
    skeletonIntro: "A skeleton is not a glossary. Every node has a type, question, prerequisite, boundary and learning priority; four template domains currently test the structure.",
