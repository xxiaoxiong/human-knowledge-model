...
当前版本已完成总体架构、Ontology、分类原则、一级知识地图，并冻结 v0.2.0 的 248 个 H3 子领域、10 个跨域桥接视图及 80 条外部分类 crosswalk。阶段 3 已在 16 个领域发布 207 个核心骨架节点和 1,035 条生成关系；其余领域骨架、思维模型库和问题求解框架将在此基础上逐层展开。
...
| 3. 领域骨架 | **进行中 v0.3-draft** | 16 个领域共 207 个节点、1,035 条骨架关系；其余 4 域待扩展 |
...
版本：`0.2.0`（冻结范围地图） / `0.3.0-draft`（领域骨架）
